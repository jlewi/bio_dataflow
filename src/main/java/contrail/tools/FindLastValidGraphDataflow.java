 ...
 *
 * This is equivalent to FindLastValidGraph but uses Dataflow.
 *
 ...
 */
public class FindLastValidGraphDataflow extends PipelineStage {
  private static final Logger sLogger = Logger.getLogger(
      FindLastValidGraphDataflow.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(
        new Configuration(), new FindLastValidGraphDataflow(), args);
    System.exit(res);
  }
}
